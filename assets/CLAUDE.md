...
- `app-icon/shardlane-{16,32,128,256,512}{,@2x}.png` — multi-resolution ladder for the Shardlane macOS app icon, rasterized per-size from `shardlane-d-dark.svg` by `scripts/render-app-icon.swift` on the Apple icon grid (824/1024 shape, transparent margins, 2026-09-09); `scripts/package-macos.sh` force-rebuilds `.app/Contents/Resources/Shardlane.icns` from this ladder via iconutil, overriding whatever cargo-bundle generated.
